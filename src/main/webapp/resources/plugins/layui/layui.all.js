...
;!function(e) {
	...
	w.prototype = [], w.prototype.constructor = w, T.extend = function() {
		...
		delete i.startState
		, i.endState = !0), "string" == typeof l && l ? i.EXP_IF.test(l) ? r.range ? (l = l.split(" " + r.range + " "), i.startDate = i.startDate || i.systemDate(), i.endDate = i.endDate || i.systemDate(), r.dateTime = T.extend({}, i.startDate), T.each([ i.startDate, i.endDate ], function(e, t) {
			m(t, l[e], e)
		...
		var e = this;
		e.config;T.each(e.elemCont, function(t, n) {
		...
		var t = this,
			...
			l = function(e) {
				new Date;e && T.extend(a, r), n.range && (t.startDate ? T.extend(t.startDate, r) : t.startDate = T.extend({}, r, t.startTime), t.startYMD = r)
			};
		if (r = {
				year : 0 | r[0],
				month : (0 | r[1]) - 1,
			...
			if (n.range) {
				if (T.each([ "startTime", "endTime" ], function(e, n) {
					...
					,
					delete t.endDate
					, t.startState = !0, i.removeClass(o + " " + m), e.addClass(o);
		...
		var n = this,
			...
			o = {
				...
				clear : function() {
					n.setValue("").remove(), r && (T.extend(i, n.firstDate), n.calendar()), a.range && (
					delete n.startState
					,
					delete n.endState
					,
		...
		var e = this;
		e.config;T(e.elem).on("click", function(e) {
			T.stope(e)
	...
	A.prototype.config = {
		...
		"string" == typeof e && u.layHeader.find("th").each(function(i, a) {
			...
			field : r,
			sort : i
		}, "asc" === i ? c = layui.sort(y, r) : "desc" === i ? c = layui.sort(y, r, !0) : (c = layui.sort(y, d.config.indexName),
		delete u.sortKey
		), u.renderData({
			data : c
		}, u.page, u.count, !0), l.close(u.tipsIndex), n && layui.event.call(e, s, "sort(" + h + ")", {
			field : r,
			type : i
		})
